...
import com.quizzo.core.utils.datetime.provider.AuditingDateTimeProvider;
import com.quizzo.core.utils.datetime.provider.DateTimeService;
...
@EnableJpaRepositories(basePackages = {"com.quizzo"})
@EntityScan(basePackages = {"com.quizzo"})
