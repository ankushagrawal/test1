...
public class QCustomLockEntity extends EntityPathBase<CustomLockEntity> {
    ...
    private static final long serialVersionUID = -1451365583L;
    ...
    public final EnumPath<com.quizzo.core.domain.enums.CustomLockNameEnum> entityName = createEnum("entityName", com.quizzo.core.domain.enums.CustomLockNameEnum.class);
